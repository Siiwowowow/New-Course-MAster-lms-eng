  ...
  const cardsData = [
    {
      ...
      date: 'April 20, 2025',
      review:
        'This course completely changed my career path. The projects were very practical and helpful.'
    },
    {
      ...
      date: 'May 10, 2025',
      review:
        'The mentors were very supportive and explained every topic in a simple and clear way.'
    },
    {
      ...
      date: 'June 5, 2025',
      review:
        'I landed my first freelance project after completing this course. Highly recommended!'
    },
    {
      ...
      date: 'May 10, 2025',
      review:
        'Very well-structured course content. It helped me build confidence step by step.'
    },
  ];
    ...
    <>
      ...
      <div className="text-center py-8 px-4">
        ...
        <p className="mt-3 text-gray-600 max-w-2xl mx-auto text-sm md:text-base">
          Real feedback from our students who improved their skills, built confidence,
          and started their professional careers with our platform.
        </p>
      </div>
